...
class BootstrapFormHelper extends FormHelper {
    ...
    protected $_defaultConfig = [
        ...
        'templates' => [
            ...
            'checkbox' => '<div class="checkbox{{attrs.class}}"><input type="checkbox" name="{{name}}" value="{{value}}"{{attrs}}>',
            'checkboxFormGroup' => '{{label}}</div>',
            'checkboxWrapper' => '<div class="checkbox">{{label}}</div>',
            'checkboxContainer' => '{{h_checkboxContainer_start}}{{content}}{{h_checkboxContainer_end}}',
